...
gpg --quiet --batch --yes --decrypt --passphrase="$PASSPHRASE" --output "$GITHUB_WORKSPACE"/assets/config/algolia.json "$GITHUB_WORKSPACE"/encrypted_config/algolia.json.gpg
