...
class MockFrenchBeloteScoreRepository extends _i1.Mock
  ...
  set connectionString(String? _connectionString) => super.noSuchMethod(
      ...
      returnValueForMissingStub: null);
  @override
  _i4.Future<_i5.FrenchBeloteScore?> get(String? id) =>
  ...
  _i4.Future<void> partialUpdate(
          _i5.FrenchBeloteScore? t, Map<String, dynamic>? partToUpdate) =>
      (super.noSuchMethod(Invocation.method(#partialUpdate, [t, partToUpdate]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i4.Future<void>);
  @override
  _i4.Future<void> update(_i5.FrenchBeloteScore? t) =>
      (super.noSuchMethod(Invocation.method(#update, [t]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i4.Future<void>);
  @override
  _i4.Future<String> create(_i5.FrenchBeloteScore? t) =>
