  ...
  group('PlayerService - ', () {
    group('Create', () {
      test('OK', () async {
        ...
        when(
          mockPlayerRepository.create(player),
    ...
    group('Increment played games', () {
      ...
      test('Player does not exist', () async {
        ...
        expect(
          playerService.incrementPlayedGamesByOne(uid, game),
      ...
      test('Throw exception Id null', () async {
        ...
        expect(
          playerService.incrementPlayedGamesByOne(null, game),
          throwsA(isA<ServiceException>()),
        );
      ...
      test('Throw exception Game null', () async {
        ...
        expect(
          playerService.incrementPlayedGamesByOne(uid, null),
          throwsA(isA<ServiceException>()),
        );
        verifyNever(mockPlayerRepository.get(uid));
        verifyNever(mockPlayerRepository.update(player));
    ...
    group('Increment won games', () {
      ...
      test('Player does not exist', () async {
        ...
        expect(
          playerService.incrementWonGamesByOne(uid, game),
          throwsA(isA<ServiceException>()),
        );
        verify(mockPlayerRepository.get(uid)).called(1);
        verifyNever(mockPlayerRepository.update(player));
      ...
      test('Throw exception Id null', () async {
        ...
        expect(
          playerService.incrementWonGamesByOne(null, game),
          throwsA(isA<ServiceException>()),
        );
        verifyNever(mockPlayerRepository.get(uid));
        verifyNever(mockPlayerRepository.update(player));
      ...
      test('Throw exception Game null', () async {
        ...
        expect(
          playerService.incrementWonGamesByOne(uid, null),
          throwsA(isA<ServiceException>()),
        );
        verifyNever(mockPlayerRepository.get(uid));
        verifyNever(mockPlayerRepository.update(player));
    ...
    group('Get player of user', () {
      test('OK', () async {
        ...
        when(
          mockPlayerRepository.getPlayerOfUser(userId),
        ).thenAnswer((_) async => Future<Player?>(() => player));
        final playerService = PlayerService(
          playerRepository: mockPlayerRepository,
        );
