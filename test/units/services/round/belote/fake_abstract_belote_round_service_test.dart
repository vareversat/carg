...
class FakeAbstractBeloteRoundServiceTest extends AbstractBeloteRoundService {
  FakeAbstractBeloteRoundServiceTest({
  ...
  group('TarotRoundService', () {
    group('Add round to game', () {
      test('OK', () async {
        ...
        final roundService = FakeAbstractBeloteRoundServiceTest(
