...
import 'package:carg/repositories/player/abstract_player_repository.dart'
    as _i4;
import 'package:carg/services/impl/player_service.dart' as _i10;
...
class MockTeamRepository extends _i1.Mock implements _i7.TeamRepository {
  ...
  @override
  _i9.Future<_i3.Team?> get(String? id) => (super.noSuchMethod(
        Invocation.method(
          #get,
          [id],
        ),
        returnValue: _i9.Future<_i3.Team?>.value(),
      ) as _i9.Future<_i3.Team?>);

  @override
  _i9.Future<List<_i3.Team>> getAllTeamOfPlayer(
    String? playerId,
    int? pageSize,
  ) =>
      (super.noSuchMethod(
        ...
        returnValue: _i9.Future<List<_i3.Team>>.value(<_i3.Team>[]),
      ) as _i9.Future<List<_i3.Team>>);

  @override
  _i9.Future<_i3.Team?> getTeamByPlayers(List<String?>? playerIds) =>
      (super.noSuchMethod(
        Invocation.method(
          #getTeamByPlayers,
          [playerIds],
  ...
  @override
  _i9.Future<_i3.Team> createTeamWithPlayers(List<String?>? playerIds) =>
      (super.noSuchMethod(
        Invocation.method(
          #createTeamWithPlayers,
          [playerIds],
        ),
        returnValue: _i9.Future<_i3.Team>.value(_FakeTeam_1(
          this,
          Invocation.method(
            #createTeamWithPlayers,
            [playerIds],
  ...
  @override
  _i9.Future<void> update(_i3.Team? t) => (super.noSuchMethod(
        Invocation.method(
          #update,
          [t],
        ),
  ...
  @override
  _i9.Future<String> create(_i3.Team? t) => (super.noSuchMethod(
        Invocation.method(
          #create,
          [t],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockPlayerService extends _i1.Mock implements _i10.PlayerService {
  MockPlayerService() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i6.BaseRepository<_i11.Player> get repository => (super.noSuchMethod(
        Invocation.getter(#repository),
        returnValue: _FakeBaseRepository_3<_i11.Player>(
          this,
          Invocation.getter(#repository),
        ),
      ) as _i6.BaseRepository<_i11.Player>);

  @override
  _i9.Future<String> create(_i11.Player? t) => (super.noSuchMethod(
        Invocation.method(
          #create,
          [t],
        ),
  ...
  @override
  _i9.Future<_i11.Player?> getPlayerOfUser(String? userId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPlayerOfUser,
          [userId],
  ...
  @override
  _i9.Future<List<_i11.Player>> searchPlayers({
    String? query = r'',
    _i11.Player? currentPlayer,
    bool? myPlayers,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
        ...
        returnValue: _i9.Future<List<_i11.Player>>.value(<_i11.Player>[]),
      ) as _i9.Future<List<_i11.Player>>);
  ...
  @override
  _i9.Future<_i11.Player?> get(String? id) => (super.noSuchMethod(
        Invocation.method(
          #get,
          [id],
        ),
  ...
  @override
  _i9.Future<void> update(_i11.Player? t) => (super.noSuchMethod(
        Invocation.method(
          #update,
          [t],
        ),
