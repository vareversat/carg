...
@GenerateMocks([TeamRepository, PlayerService])
void main() {
  ...
  group('TeamService - ', () {
    group('Get Team By Players', () {
      test('Team exists', () async {
        ...
        when(
          mockTeamRepository.getTeamByPlayers(playerIds),
      ...
      test('Team does not exist', () async {
        ...
        when(
          mockTeamRepository.createTeamWithPlayers(playerIds),
        ).thenAnswer((_) async => Future<Team>(() => team));
        final teamService = TeamService(
          teamRepository: mockTeamRepository,
          playerService: mockPlayerService,
      ...
      test('Throw exception (from repository)', () async {
        ...
        expect(
          teamService.getTeamByPlayers(playerIds),
      ...
      test('Throw exception (from service)', () async {
        ...
        expect(
          teamService.getTeamByPlayers(null),
          throwsA(isA<ServiceException>()),
        );
    ...
    group('Increment played games', () {
      test('Team exists', () async {
        ...
        final team = Team(
          id: uid,
          gameStatsList: [gameStat],
          players: ['p1', 'p2'],
        );

        when(
          mockTeamRepository.get(uid),
        ).thenAnswer((_) async => Future<Team?>(() => team));
        final teamService = TeamService(
          teamRepository: mockTeamRepository,
          playerService: mockPlayerService,
        ...
        expect(
          (await teamService.incrementPlayedGamesByOne(
            uid,
            game,
          )).totalPlayedGames(),
          2,
      ...
      test('Team does not exist', () async {
        ...
        expect(
          teamService.incrementPlayedGamesByOne(null, game),
          throwsA(isA<ServiceException>()),
        );
      });
      ...
      test('Throw exception (from repository)', () async {
        ...
        expect(
          teamService.incrementPlayedGamesByOne(uid, game),
          throwsA(isA<ServiceException>()),
        );
      });
      ...
      test('Throw exception GAME (from service)', () async {
        ...
        expect(
          teamService.incrementPlayedGamesByOne(uid, null),
          throwsA(isA<ServiceException>()),
        );
      });
    ...
    group('Increment won games', () {
      ...
      test('Team does not exist', () async {
        ...
        expect(
          teamService.incrementWonGamesByOne(null, game),
          throwsA(isA<ServiceException>()),
        );
      });
      ...
      test('Throw exception (from repository)', () async {
        ...
        expect(
          teamService.incrementWonGamesByOne(uid, game),
          throwsA(isA<ServiceException>()),
        );
      });
      test('Throw exception GAME (from service)', () async {
        ...
        expect(
          teamService.incrementWonGamesByOne(uid, null),
          throwsA(isA<ServiceException>()),
        );
      });
      test('Throw exception GAME (team = null)', () async {
    ...
    group('Get all teams of players', () {
      test('Teams exist', () async {
        ...
        when(
          mockTeamRepository.getAllTeamOfPlayer(playerId, pageSize),
      ...
      test('Throw exception GAME (playerId = null)', () async {
        ...
        expect(
          teamService.getAllTeamOfPlayer(null, 10),
          throwsA(isA<ServiceException>()),
        );
      });
      ...
      test('Throw exception GAME (page = null)', () async {
        ...
        expect(
          teamService.getAllTeamOfPlayer(playerId, null),
          throwsA(isA<ServiceException>()),
        );
      });
      ...
      test('Throw exception (from repository)', () async {
        const playerId = 'p1';
        when(
          mockTeamRepository.getAllTeamOfPlayer(playerId, 10),
        ).thenThrow(RepositoryException('error'));
        final teamService = TeamService(
          teamRepository: mockTeamRepository,
          playerService: mockPlayerService,
        ...
        expect(
          teamService.getAllTeamOfPlayer(playerId, 10),
          throwsA(isA<ServiceException>()),
        );
      });
    });
